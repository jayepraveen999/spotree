...
{\small\textit{The capture form with Take Photo and Gallery options. The species dropdown shows Munich's native tree species with scientific names.}}
\end{minipage}\hfill
\begin{minipage}{0.30\textwidth}\centering
...
{\small\textit{Validation passed --- the ``Add Tree'' button appears, confirming the photo contains a tree and is ready for submission.}}
\end{minipage}\hfill
\begin{minipage}{0.30\textwidth}\centering
\includegraphics[height=7.5cm]{../app_screenshots/capture_6.PNG}\\
{\small\textit{``Tree verified'' badge displayed with extracted GPS coordinates. The form fields below are now active for data entry.}}
\end{minipage}
\end{center}
...
{\small\textit{A completed form with all confidence sliders set and a Spotify song linked via the ``Drop a Song'' section.}}
\end{minipage}\hfill
\begin{minipage}{0.30\textwidth}\centering
...
{\small\textit{The full capture form before filling in data, showing all available fields and the ``Drop a Song'' section at the bottom.}}
\end{minipage}
\end{center}
...
{\small\textit{Health status dropdown expanded, showing the five assessment levels from Healthy to Dead/Dying.}}
\end{minipage}\hfill
\begin{minipage}{0.30\textwidth}\centering
\includegraphics[height=7.5cm]{../app_screenshots/capture_11.PNG}\\
{\small\textit{Trunk diameter selection with notes field and the ``Drop a Song'' Spotify section visible below.}}
\end{minipage}\hfill
\begin{minipage}{0.30\textwidth}\centering
\includegraphics[height=7.5cm]{../app_screenshots/capture_12.PNG}\\
{\small\textit{Estimated height dropdown with a selected value, trunk diameter, and the Spotify link section ready for input.}}
\end{minipage}
\end{center}
